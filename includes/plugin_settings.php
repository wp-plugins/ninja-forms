...
<h2><?php printf(__('Ninja Forms %s - Plugin Settings'), NINJA_FORMS_TYPE);?></h2>

<h3><?php _e('Version');?> <?php echo $plugin_settings['version'];?></h3>
<h3><?php _e('Database Version');?> <?php echo $plugin_settings['db_version'];?></h3>
<form id="" name="" action="" method="post">
<?php wp_nonce_field('ninja_save_plugin_settings','ninja_plugin_settings'); ?>
<input type="hidden" name="submitted" value="yes">
<input type="hidden" name="default_style" value="unchecked"><input type="checkbox" name="default_style" id="default_style" value="checked" <?php echo $plugin_settings['default_style'];?>><label for="default_style"> <?php _e('Use Ninja Forms Default Stylesheet');?></label><br />
<input type="hidden" name="admin_help" value="unchecked"><input type="checkbox" name="admin_help" id="admin_help" value="checked" <?php echo $plugin_settings['admin_help'];?>><label for="admin_help"> <?php _e('Show Admin Help/Tips');?></label><br />
<h4><?php _e('Form Help/Tips hover color scheme');?>:</h4>
...
<label for="help_size"><h4><?php _e('Help/Tip Box Size');?>:</h4> <input type="text" name="help_size" id="help_size" value="<?php echo $plugin_settings['help_size'];?>" class="ninja_forms_settings"></label>

<p><?php _e('Mouse-over to see your changes');?>: <img id='show_help_color' src='<?php echo NINJA_FORMS_URL;?>/images/question-ico.gif'></p>
