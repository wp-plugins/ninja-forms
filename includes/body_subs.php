...
<table class="widefat tablesorter" cellspacing="0" id="ninja_subs_table"> 
	<thead> 
		<tr> 
			<th class="mange-column" width="20%">Action</th> 
			<th class="mange-column" width="20%">Date</th> 
		<?php
...
<tr id="sub_<?php echo $sub['id'];?>_visible" class="sub_tr_<?php echo $sub['id'];?>">
		<td width="20%"><span class="delete"><a href="#" id="sub_<?php echo $sub['id'];?>" class="ninja_delete_sub">Delete</a></span><?php if($current_fields || $old_values){ ?> | <a href="#" id="more_<?php echo $sub['id'];?>" class="ninja_sub_more">More</a><?php } ?></td>
...
<tr id="sub_<?php echo $sub['id'];?>_more" class="expand-child sub_tr_<?php echo $sub['id'];?>" style="display:none;">
	<td colspan="2">
		<strong>Other Fields:</strong><div class="other-fields" style="border-style:solid;border-width:1px;padding:5px">
	<?php
			foreach($current_fields as $field){
				foreach($form_values as $value){
	...
	<?php
		if($old_values){
			?>
			<strong>Old Values:</strong><div class="old-fields"  style="border-style:solid;border-width:1px;padding:5px">
			<?php
