...
?>
	...
	<p class="description description-wide">
		...
		<div class="form-section">
			<input type="submit" name="submit" id="" class="button-primary" value="Backup Ninja Forms">
		</div>
	</p>
	<p class="description description-wide">
		...
		<div class="form-section">
			...
			<input type="submit" name="submit" id="" class="button-primary" value="Restore Ninja Forms">
		<?php
		if(isset($_POST['submit']) AND isset($_POST['ninja_forms_restore'])){
		?>
			<div id="message" class="updated below-h2">
				<p>Data restored successfully!</p>
			</div>
		<?php
		}
		?>
