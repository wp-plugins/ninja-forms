<?php
add_action('init', 'ninja_forms_register_fields_edit_sub_post_process');
function ninja_forms_register_fields_edit_sub_post_process(){
	add_action('ninja_forms_edit_sub_post_process', 'ninja_forms_fields_edit_sub_post_process', 999 );	
}
